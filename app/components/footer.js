            ...
            <div className="mt-8 lg:mt-0">
              <form className="sm:flex">
                ...
                <input
                  ...
                  id="email-address"
                  required
                  className="w-full px-5 py-3 placeholder-gray-500 focus:ring-2 focus:ring-white focus:border-white sm:max-w-xs rounded-l-md text-gray-900"
                  placeholder="Tu email"
                />
                <div className="mt-3 rounded-md sm:mt-0 sm:ml-3 sm:flex-shrink-0">
                  <button
                    type="submit"
                    className="w-full bg-white px-5 py-3 text-red-600 hover:bg-red-50 font-medium rounded-r-md transition-colors focus:outline-none focus:ring-2 focus:ring-white"
                  >
                    Suscribirse
                  </button>
                </div>
      ...
      <div className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            <h4 className="text-lg font-bold">SOLYMAR</h4>
            ...
            <div className="flex space-x-4">
              ...
              <Link href="https://www.instagram.com/solymarhogar/" className="text-red-100 hover:text-white transition-colors">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link href="/contacto" className="text-red-100 hover:text-white transition-colors">
                  Contacto
                </Link>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link href="/returns" className="text-red-100 hover:text-white transition-colors">
                  Devoluciones
                </Link>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li className="flex items-center text-red-100">
                ...
                José Ingenieros 1947, Beccar, Buenos Aires 1643
              </li>
            </ul>
          </div>
        </div>
        ...
        <div className="mt-12 pt-8 border-t border-red-500">
          <div className="text-center text-red-100">
            <p>© {new Date().getFullYear()} Solymar. Todos los derechos reservados.</p>
